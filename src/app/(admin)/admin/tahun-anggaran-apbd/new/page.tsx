...
export default function NewTahunAnggaranAPBDPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error("Failed to create tahun anggaran APBD");
      }
    } catch (error) {
      console.error("Error creating tahun anggaran APBD:", error);
      alert("Gagal membuat data. Silakan coba lagi.");
    } finally {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Tambah Tahun Anggaran APBD</h1>
        <p className="text-gray-600 mt-1">Tambah data tahun anggaran APBD baru</p>
      </div>
